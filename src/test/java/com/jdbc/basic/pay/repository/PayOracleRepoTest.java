...
class PayOracleRepoTest {
    ...
    void removeTest() {
        ...
        // then - 예상 결과
        Pay pay = repository.findOne(empNum);
    ...
    void findOneTest() {
        ...
        Pay payOne = repository.findOne(empNum);
    ...
    void modifyTest() {
        ...
        // then
        Pay newPay = repository.findOne(empNum);
    ...
    void findAllTest() {
        ...
        Map<String, Pay> payMap = repository.findAll();
